...
If you rely on stable, production-grade imaging tools, consider established alternatives until Rufus-Py reaches a stable release.
...
- `tkinter_gui/main.py`
- It **does not import anything** from `src/rufus_py/...`
...
This step keeps Rufus-Py’s Python packages separate from the rest of your system.
...
- A terminal message prints something like:
  ...
  ```
- A window titled **“Rufus-Py (Tkinter prototype)”** opens.
...
Rufus-Py is a **drive formatting and imaging tool**. Some actions are **destructive**:
